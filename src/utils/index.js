...
module.exports = {
  OTPGenerator: function () {
    if (!/PROD/.test(process.env.CONFIG_ARG)) return 2112;
  ...
  generateUniqueFileName: () => {
    return "iLost" + crypto.randomUUID();
  },
  ...
  roundToNearest : (number) => {
    ...
    if (number >= 100000000) {
      // return number;
      return Math.ceil(number / 100000000) * 100000000; // Round to the nearest one billion 
    } else if (number >= 100000000) {
      return Math.ceil(number / 100000000) * 100000000; // Round to the nearest 100 million
    } else if (number >= 10000000) {
      return Math.ceil(number / 10000000) * 10000000; // Round to the nearest ten million
    } else if (number >= 1000000) {
      return Math.ceil(number / 1000000) * 1000000; // Round to the nearest million
    } else if (number >= 100000) {
      return Math.ceil(number / 100000) * 100000; // Round to the nearest hundred thousand
    } else if (number >= 10000) {
      return Math.ceil(number / 10000) * 10000; // Round to the nearest ten thousand
    } else if (number >= 1000) {
      return Math.ceil(number / 1000) * 1000; // Round to the nearest thousand
    } else if (number >= 100) {
      return Math.ceil(number / 100) * 100; // Round to the nearest hundred
    } else if (number >= 10) {
      return Math.ceil(number / 10) * 10; // Round to the nearest ten
    } else {
      return Math.ceil(number); // No rounding needed
    }
  },
